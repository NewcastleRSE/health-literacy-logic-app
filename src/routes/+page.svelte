...
<div class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8 dark:bg-gray-900">
  <img src="assets/images/hush-naidoo-jade-photography-yo01Z-9HQAw-unsplash.jpg" alt="a stethoscope" class="absolute inset-0 -z-10 size-full object-cover opacity-10 dark:hidden" />
  ...
  <div class="mx-auto max-w-2xl text-center">
    <h2 class="text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl dark:text-white">Health Literacy<br/>logic tool</h2>
